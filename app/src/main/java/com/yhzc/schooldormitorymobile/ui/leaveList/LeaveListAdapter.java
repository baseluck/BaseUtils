 ...
 * @描述:
 */
public class LeaveListAdapter extends BaseQuickAdapter<LeaveListModel.DataBean, BaseViewHolder> {
    public LeaveListAdapter(int layoutResId, @Nullable List<LeaveListModel.DataBean> data) {
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, LeaveListModel.DataBean dataBean) {
        ...
        baseViewHolder.setText(R.id.tv_hqsy, String.format(StringUtils.getString(R.string.leave_reason), dataBean.getLeaveType()));
