 ...
 * @描述:
 */
public class EditorNewAdapter extends BaseQuickAdapter<EditorModel, BaseViewHolder> {

    public EditorNewAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, EditorModel editorModel) {
        ...
        Glide.with(getContext())
            ...
            baseViewHolder.setText(R.id.tv_editor, "删除");
            baseViewHolder.setTextColor(R.id.tv_editor, 0xfffe757c);
