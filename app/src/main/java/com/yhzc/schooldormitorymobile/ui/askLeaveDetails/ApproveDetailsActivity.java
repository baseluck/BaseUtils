 ...
 * @描述: 请假详情
 */
public class ApproveDetailsActivity extends BaseActivity<LeaveDetailsViewModel, ActivityAskLeaveDetailsBinding> {
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        if (StringUtils.equals("receiveApplyLeaveProcess", workType)||StringUtils.equals("enterStockProcess", workType)) {
        ...
        mViewDataBind.tvBl.setOnClickListener(v -> showBl());
        mViewDataBind.tvWp.setOnClickListener(v -> initUser());
        initImgRv();
        initRv();
    }
