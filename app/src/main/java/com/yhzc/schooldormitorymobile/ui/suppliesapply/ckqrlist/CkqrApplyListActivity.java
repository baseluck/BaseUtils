package com.yhzc.schooldormitorymobile.ui.suppliesapply.ckqrlist;
...
import com.yhzc.schooldormitorymobile.ui.suppliesapply.rkqrlist.RkqrApplyAdapter;
 ...
 * @描述: 物资申请列表
 */
public class CkqrApplyListActivity extends BaseActivity<SuppliesApplyViewModel, ActivityTaskListBinding> {
    ...
    protected void onResume() {
        super.onResume();
        currentPage = 1;
        mViewModel.initCkqrList(currentPage, blQr);
    }
