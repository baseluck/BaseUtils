package com.yhzc.schooldormitorymobile.ui.suppliesapply.applydetails;
 ...
 * @描述: 物资申请详情
 */
public class WzApplyDetailsActivity extends BaseActivity<LeaveDetailsViewModel, ActivityAskLeaveDetailsBinding> {
