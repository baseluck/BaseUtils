 ...
 * @描述: 绩效打分详情
 */
public class PerformanceDetailsSubmitActivity extends BaseActivity<PerformanceDetailsViewModel, ActivityPerformanceDetailsBinding> {
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        mThirdAdapter = new ThirdAdapter(R.layout.item_khxq_content_submit, null);
