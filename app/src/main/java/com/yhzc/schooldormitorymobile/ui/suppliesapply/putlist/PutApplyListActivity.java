package com.yhzc.schooldormitorymobile.ui.suppliesapply.putlist;
...
import com.yhzc.schooldormitorymobile.ui.suppliesapply.applylist.WzApplyAdapter;
import com.yhzc.schooldormitorymobile.ui.suppliesapply.putapply.PutApplyActivity;
import com.yhzc.schooldormitorymobile.ui.suppliesapply.putdetails.WzPutDetailsActivity;
 ...
 * @描述: 物资申请列表
 */
public class PutApplyListActivity extends BaseActivity<SuppliesApplyViewModel, ActivityTaskListBinding> {

    private final String[] tabs = new String[]{"待处理", "已处理"};
    private WzApplyAdapter mLeaveListAdapter;
    private int status = 1;
    private final String workType = "enterStockProcess";
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        showRightTextAndOnClickListener("申请", v -> ActivityUtils.startActivity(PutApplyActivity.class));
    }
