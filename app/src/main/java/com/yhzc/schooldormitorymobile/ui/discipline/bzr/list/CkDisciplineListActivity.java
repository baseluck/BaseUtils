package com.yhzc.schooldormitorymobile.ui.discipline.bzr.list;
...
import com.yhzc.schooldormitorymobile.ui.discipline.bzr.details.CkDisciplineDetailsActivity;
import com.yhzc.schooldormitorymobile.ui.discipline.list.DisciplineAdapter;
 ...
 * @描述: 违纪列表
 */
public class CkDisciplineListActivity extends BaseActivity<DisciplineViewModel, ActivityDisciplineListBinding> {
    ...
    protected void onResume() {
        ...
        if (!StringUtils.isEmpty(type)) {
            mViewModel.initCkList(currentPage, type);
        }
    }
...
//        });
    ...
    private void initRv() {
        ...
        mDisciplineAdapter.setOnItemClickListener((adapter, view, position) -> {
            ...
            Intent intent = new Intent(this, CkDisciplineDetailsActivity.class);
