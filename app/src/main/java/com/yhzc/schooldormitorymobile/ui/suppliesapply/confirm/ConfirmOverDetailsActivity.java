 ...
 * @描述: 退库详情
 */
public class ConfirmOverDetailsActivity extends BaseActivity<SuppliesApplyViewModel, ActivityConfirmDetailsBinding> {
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        mViewDataBind.tvAddImg.setVisibility(View.GONE);
        mViewModel.getReturnDetailsModel().observe(this, returnDetailsModel -> {
            if (returnDetailsModel != null) {
                ...
                if (!StringUtils.isEmpty(returnDetailsModel.getData().getVcFiles())) {
                    String[] split = returnDetailsModel.getData().getVcFiles().split(",");
