 ...
 * @描述: 违纪详情-发布-修改
 */
public class DisciplineDetailsActivity extends BaseActivity<DisciplineViewModel, ActivityDisciplineDetailsBinding> {
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        if (StringUtils.equals("1", wjType)) {
            ...
            mViewDataBind.clBottom.setVisibility(View.VISIBLE);
            canChange = false;
            setData();
