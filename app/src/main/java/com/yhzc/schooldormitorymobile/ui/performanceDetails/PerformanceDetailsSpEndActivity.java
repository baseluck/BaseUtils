 ...
 * @描述: 绩效打分详情
 */
public class PerformanceDetailsSpEndActivity extends BaseActivity<PerformanceDetailsViewModel, ActivityPerformanceDetailsBinding> {

    private FirstAdapter mFirstAdapter;
    private SecondAdapter mSecondAdapter;
    private SpThirdAdapter mThirdAdapter;
    private String plan;
    ...
    protected void afterCreate(Bundle savedInstanceState) {
        ...
        mThirdAdapter = new SpThirdAdapter(R.layout.item_khxq_content_pj, null);
        ...
        mViewModel.getDetailsModel().observe(this, performanceDetailsModel -> {
            ...
            if (performanceDetailsModel != null) {
                mViewDataBind.tvXz.setVisibility(View.VISIBLE);
                mViewDataBind.tvRank.setVisibility(View.VISIBLE);
                mViewDataBind.tvXz.setText(String.format(StringUtils.getString(R.string.khxq_zdf), performanceDetailsModel.getData().getTotalScore()));
                mViewDataBind.tvRank.setText(String.format(StringUtils.getString(R.string.khxq_rank), performanceDetailsModel.getData().getRank()));
        ...
        mViewDataBind.tvSend.setVisibility(View.GONE);
