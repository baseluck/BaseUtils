 ...
 * @描述:
 */
public class HealthTaskListAdapter extends BaseQuickAdapter<TaskListModel.DataBean.ListBean, BaseViewHolder> implements LoadMoreModule {

    public static final int ONGOING = 2;
    public static final int OVER = 3;

    public HealthTaskListAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(@NotNull BaseViewHolder baseViewHolder, TaskListModel.DataBean.ListBean listBean) {
        ...
        baseViewHolder.setText(R.id.tv_user, String.format(StringUtils.getString(R.string.check_bed_task_list_user), listBean.getVcUserName()));
